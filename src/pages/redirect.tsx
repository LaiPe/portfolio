...
import * as styles from "../assets/css/pages/RedirectPage.module.css";
        ...
        <div className={styles.content}>
          <div className={styles.heading}>
            ...
            <p className={styles.subtitle}>
              Le site que vous venez de consulter était une maquette.
            </p>
          </div>
...
export const Head: HeadFC = () => (
  <Seo
    title="Ça vous a plu ? | Léo Peyronnet - Portfolio"
    description="Page de redirection vers le portfolio de Léo Peyronnet"
  />
);
